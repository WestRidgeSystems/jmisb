...
/**
 * Number of Sections in X (ST 1002 Range Image Local Set Tag 17).
 *
...
public class NumberOfSectionsInX implements IRangeImageMetadataValue {
     ...
     */
    public NumberOfSectionsInX(int numberOfSections) {
        if (numberOfSections < 1) {
            throw new IllegalArgumentException("ST 1002 Number of Sections in X must be positive");
        }
     ...
     */
    public NumberOfSectionsInX(byte[] bytes) {
    ...
    public String getDisplayName() {
        return "Number of Sections in X";
    }
