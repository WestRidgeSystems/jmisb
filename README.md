...
| ST 1201    | Floating Point to Integer Mapping                                               | Fully implemented per ST 1201.4.                                                                                   |                                                                                                                          |
...
| ST 1303    | Multi-Dimensional Array Pack (MDAP)                                             | Partly implemented as of ST 1303.2. Only formats and dimensions known to be used are available. Limited testing.   |                                                                                                                          |
...
| ST 1909    | Metadata Overlay for Visualization                                              | Mostly implemented. No support for next zoom or the reticle.                                                       | [97](https://github.com/WestRidgeSystems/jmisb/issues/97)                                                                |
...
```groovy
dependencies {
    compile group: 'org.jmisb', name: 'jmisb-api', version: '1.10.0'
}
```
