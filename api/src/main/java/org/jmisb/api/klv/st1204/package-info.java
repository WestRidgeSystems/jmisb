 ...
 * <p>
 * The Motion Imagery Identification System (MIIS)-Core Identifier addresses this
 ...
 * manage and exploit Motion Imagery. MISB ST 1301 [1] defines and documents
 * Augmentation Identifiers.
 * <p>
 * The MIIS solves four problems:
 * <ol>
 * <li>Determining whether two (or more) Motion Imagery streams or files are
 * from the same source (sensor/platform).</li>
 * <li>Determining whether two (or more) Motion Imagery streams or files are
 * from two different sources.</li>
 * <li>Basis for pedigree information about the Motion Imagery (i.e., tracking
 * all Motion Imagery manipulations from source through receiver).</li>
 * <li>Linking useful identifying information about the Motion Imagery stream
 * or file to the Motion Imagery source.</li>
 * </ol>
 * <p>
 * When fully implemented, the MIIS fulfills the need to provide a consistent
 * and unique identifier for all sensors and platforms.
 * </blockquote>
 *
 ...
 * support since the value of the <code>MiisCoreId</code> element is the same
 * format as the text representation.
 */
