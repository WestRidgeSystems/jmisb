 ...
 * From ST0903:
 * <blockquote>
 * Provides systems downstream a means to intelligently cull targets for a given
 * frame.
 * <p>
 * For example, VMTI processors may generate thousands of hits.
 * </blockquote>
 */
public class TargetPriority implements IVmtiMetadataValue {
    ...
    public TargetPriority(short priority)
    {
        ...
        {
            throw new IllegalArgumentException(this.getDisplayName() + " value must be in range [1,255]");
        }
