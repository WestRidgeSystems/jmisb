...
public class UniversalSetFactory
{
    ...
    public static ISecurityMetadataValue createValue(SecurityMetadataKey key, byte[] bytes)
    {
        ...
        switch (key)
        {
            ...
            case CcCodingMethod:
                return new SecurityMetadataString(SecurityMetadataString.COUNTRY_CODING_METHOD, bytes);
            ...
            case OcCodingMethod:
                return new SecurityMetadataString(SecurityMetadataString.OBJECT_COUNTRY_CODING_METHOD, bytes);
