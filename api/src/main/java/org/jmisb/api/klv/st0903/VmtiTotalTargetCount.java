 ...
 * <blockquote>
 *
 * Total number of moving targets detected in the Frame. Particularly relevant when the number of
 * targets reported (VMTI LS Tag 6) is less than the total number detected in the frame.
 *
 * <p>A value of 0 represents no targets detected.
 *
 * </blockquote>
 */
