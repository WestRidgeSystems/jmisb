 ...
 * <p>
 * Used with Wavelengths List (Tag 128).
 * <p>
 * The Active Wavelength List provides a list of wavelengths used by the sensor
 * to generate the Motion Imagery. This value updates when the sensor changes
 * and the new sensor has a different wavelength than the last sensor used. For
 * example, the sensor changes from a visible light to an infrared sensor.
 * Multiple wavelengths identifiers support multi-band sensors or sensors which
...
public class ActiveWavelengthList implements IUasDatalinkValue
{
     ...
     * Create from value.
     * <p>
     * This valid identifiers should be from the defined set (1-7), or 21 and
     * higher as defined by Tag 128.
     * <p>
    ...
    public String getDisplayableValue()
    {
        ...
        wavelengthIdentifiers.forEach((wavelengthIdentifier) -> {
