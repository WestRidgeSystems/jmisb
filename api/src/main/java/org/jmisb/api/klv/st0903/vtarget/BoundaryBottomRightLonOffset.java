 ...
 * From ST0903:
 * <blockquote>
 * Longitude offset for bottom right corner of target bounding box from Frame
 * Center Longitude (MISB ST 0601), based on WGS84 ellipsoid. Use with Frame
 * Center Longitude. Added to the Frame Center Longitude from the parent ST 0601
 * packet to determine the Longitude of the bottom right corner of the target
