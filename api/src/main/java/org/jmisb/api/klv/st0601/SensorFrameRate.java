 ...
 * <blockquote>
 *
 * The Sensor Frame Rate Pack consists of two unsigned integers used to compute the frame rate. The
 * ratio of the two integers provides the capability to compute both integer and drop-frame frame
 * rates. For example, typical integer frame rates of 30, 60 are the ratio of 30/1 and 60/1,
 * respectively. While drop-frame rates of 29.97 and 59.94 are the ratio of 30000/1001 and
 * 60000/1001, respectively.
 *
 * <p>The Sensor Frame Rate Pack is a two-element truncation pack where the first element is the
