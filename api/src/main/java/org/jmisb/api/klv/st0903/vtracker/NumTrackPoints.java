 ...
 * <blockquote>
 *
 * The number of coordinates of type Location that describe the trackHistorySeries of VMTI
 * detections for the target. Strictly speaking, Number of Track Points is unnecessary, since the
 * value is derivable from the Length information associated with VTracker Tag 9 trackHistorySeries.
 * If specified, the number of track points needs to be at least 1, else no trackHistorySeries would
 * exist.
 *
 * <p>Valid Values: The set of all integers from 1 to 65,536 inclusive
 *
 * </blockquote>
 */
    ...
    public NumTrackPoints(int value) {
        if (value < MIN_VALUE || value > MAX_VALUE) {
            throw new IllegalArgumentException(
                    this.getDisplayName() + " must be in range [1,65535]");
        }
        this.value = value;
    }
