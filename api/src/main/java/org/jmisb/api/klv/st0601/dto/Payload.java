 ...
 *
 * This is used by Payload List (ST0601 Tag 138).
 */
public class Payload
{
     ...
     *
     * The Payload Identifier is a unique BER-OID integer sequentially assigned
     * starting with the number zero (0). The Active Payload (Tag 139) uses the
     * Payload Identifier to specify which payloads are active.
     *
     ...
     *
     * The Payload Type is a BER-OID enumeration. Valid values are 0 for Electro
     * Optical MI Sensor; 1 for LIDAR; 2 for RADAR; 3 for SIGINT; 4 for SAR.
     *
     ...
     *
     * Examples of this are "VIS Nose Camera", "ACME VIS Model 123" or "ACME IR
     * Model 456"
     *
