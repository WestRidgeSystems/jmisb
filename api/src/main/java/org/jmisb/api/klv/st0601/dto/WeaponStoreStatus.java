 ...
 *
 * This is the "General Status" from ST0601 Tag 140.
 */
public enum WeaponStoreStatus
{
    ...
    /**
     * Ready/Degraded - Store initialization completed – full capability not
     * available.
     */
    ReadyDegraded((byte) 2),
    /**
     * Ready/All Up Round - Store initialization completed – full capability is
     * available.
     */
    ReadyAllUpRound((byte) 3),
    /**
     * Launch - Dedicated release processes started including activation of
    ...
    MissFire((byte) 7),
    /**
     * Hang Fire - Weapon which does not separate from aircraft when activated
     * for employment or jettison.
     */
    HangFire((byte) 8),
    /**
     * Jettisoned - Intentional or emergency separation of weapon from aircraft
     * with the weapon in the unarmed state (fuze-safe).
     */
    Jettisoned((byte) 9),
    /**
     * Stepped Over - Weapon is bypassed due to failure. Weapon can still be
     * jettisoned.
     */
    SteppedOver((byte) 10),
    /**
