...
public enum VTrackerMetadataKey implements IKlvKey {
    ...
    trackId(1),
    /**
     * Enumeration indicating the current state of VMTI detections for a given entity (Inactive,
     * Active, Dropped, Stopped).
     */
    detectionStatus(2),
    ...
    endTime(4),
    /**
     * Set of vertices of type Location that specify a minimum bounding area or volume, which
     * encloses the full extent of VMTI detections for the entity.
     */
    boundarySeries(5),
    /**
     * Name or description of the algorithm or method used to create or maintain object movement
     * reports or intervening predictions of such movement.
     */
    algorithm(6),
    /**
     * An estimation of the certainty or correctness of VMTI movement detections. Larger values
     * indicate greater confidence.
     */
    confidence(7),
    /**
     * Number of coordinates of type Location that describe the history of VMTI detections described
     * by trackHistorySeries.
     */
    numTrackPoints(8),
