 ...
 * <blockquote>
 *
 * Relative humidity at aircraft location. Relative Humidity is the ratio between the water vapor
 * density and the saturation point of water vapor density expressed as a percentage.
 *
 * <p>Map 0..(2^8-1) to 0..100%.
 *
 * <p>Resolution: ~0.4%.
 *
 * </blockquote>
    ...
    public RelativeHumidity(byte[] bytes) {
        if (bytes.length != 1) {
            throw new IllegalArgumentException(
                    "Relative humidity encoding is a 1-byte unsigned int");
        }
