 ...
 * From ST0903:
 * <blockquote>
 * Latitude offset for target from Frame Center Latitude (MISB ST 0601), based
 * on WGS84 ellipsoid. Has meaning only when embedding the VMTI LS in ST 0601
 * LS. The Target Location Latitude Offset adds to the Frame Center Latitude
 * metadata item from the parent ST 0601 to determine the Latitude of the
 ...
 * location.
 * <p>
 * Target Location Latitude Offset has a real earth coordinate represented by a
