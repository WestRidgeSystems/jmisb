...
abstract class AbstractMGRSEastingOrNorthing implements IRvtMetadataValue
{
    ...
    public AbstractMGRSEastingOrNorthing(String name, int value)
    {
        ...
        {
            throw new IllegalArgumentException(this.getDisplayName() + " valid range is [0,99999].");
        }
        label = name;
        v = value;
    }
    ...
    public AbstractMGRSEastingOrNorthing(String name, byte[] bytes)
    {
        ...
        {
            throw new IllegalArgumentException(this.getDisplayName() + " encoding is a three byte unsigned integer.");
        }
        label = name;
