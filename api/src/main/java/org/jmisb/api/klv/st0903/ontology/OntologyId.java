 ...
 * <p>
 * When the VMTI LS contains a Series of Ontology Local Sets each element in the
 * Series needs a unique identifier. The Id is an integer which identifies a
 * single Ontology LS in the Series and is unique among all elements in the
 * list. Systems may reuse Ids from VMTI LS to VMTI LS (i.e., two sequential
