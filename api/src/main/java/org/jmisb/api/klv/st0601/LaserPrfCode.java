 ...
 * <p>
 * When enabled, laser designators can generate a pulsed signal according to a
 * Pulse Repetition Frequency (PRF) code which distinguishes one laser beam from
 * another.
 * </blockquote>
 * <p>
 * Direct mapping: 0...65535 to 0..65535 (noting limits above).
 * <p>
 * Resolution: N.A. Exact - integer code.
 */
public class LaserPrfCode implements IUasDatalinkValue
{
     ...
     * Create from value
     *
     * @param prfCode The PRF code. Legal values are in [111, 8888]. No use of
     * 0's or 9s in the code.
     */
