 ...
 *
 * <p>The Country Codes item provides country related information about the platform and its
 * operation. The country which own and fly aircraft, along with where the platform is flying, and
 * the country observed in the Motion Imagery scene are all needed information. For example, Country
 * A is flying Country B’s UAV over Country C while imaging Country D and Country E performs
 * analysis and classification of the Motion Imagery. There are five country codes of interest:
 * Operator Country, Manufacture Country, Overflight Country, Object Country (Motion Imagery Scene)
 * and Classifying Country. For the example above:
 *
 * <ul>
 *   <li>Operator = Country A
 *   <li>Manufacture = Country B
 *   <li>Overflight Country = Country C
 *   <li>Object Country = Country D
 *   <li>Classifying country = Country E
 * </ul>
 *
 * <p>The following lists the definitions for each of the different Country Code types:
 *
 * <ul>
 *   <li>Overflight Country: The country the platform is operating or flying over. This may be
 *       different than the country within the scene of the Motion Imagery.
 *   <li>Operator Country: Country where the operator is located. For example, a GCS operator.
 *   <li>Country of Manufacture: The Country where the platform was manufactured.
 *   <li>Object Country: The country within the Motion Imagery scene or the “Object” of the Motion
 *       Imagery. Note: This value is an item in MISB ST 0102 and is not included in this item’s
 *       country codes list.
 *   <li>Classifying Country: The country which initially analyzes or classified the Motion Imagery.
 *       Note: this value is an item in MISB ST 0102 and is not included in this item’s country
 *       codes list.
 * </ul>
 *
 * </blockquote>
...
public class CountryCodes implements IUasDatalinkValue {
     ...
     *     unknown.
     * @param operatorCountryCode the code for the country where the operator is located, of an
     *     empty string if unknown.
     * @param countryOfManufactureCode the code for the country where the platform was manufactured,
     *     or an empty string if unknown.
     */
    public CountryCodes(
            final CountryCodingMethod countryCodingMethod,
            final String overflightCountryCode,
            final String operatorCountryCode,
            final String countryOfManufactureCode) {
    ...
    public CountryCodes(byte[] bytes) {
        ...
        overflightCountry =
                new String(
                        bytes,
                        idx,
                        overflightCountryLengthField.getValue(),
     ...
     *
     * <p>The country the platform is operating or flying over. This may be different to the country
     * within the scene of the Motion Imagery.
     *
     * @return the overflight country (to be interpreted using the coding method for this object),
     *     or an empty string if not known.
     */
     ...
     *
     * <p>Country where the operator is located. For example, a GCS operator.
     *
     * @return the operating country (to be interpreted using the coding method for this object), or
     ...
     *
     * <p>The Country where the platform was manufactured.
     *
     * @return the country of manufacture (to be interpreted using the coding method for this
     *     object), or an empty string if not known.
     */
