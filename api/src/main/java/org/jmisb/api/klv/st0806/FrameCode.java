 ...
 *
 * Frame counter index. Counter runs at 60Hz.
 */
public class FrameCode implements IRvtMetadataValue
{
    ...
    private final static int REQUIRED_BYTE_LENGTH = 4;
    ...
    public FrameCode(byte[] bytes)
    {
        ...
        {
            throw new IllegalArgumentException(this.getDisplayName() + " encoding is a four byte unsigned integer");
        }
