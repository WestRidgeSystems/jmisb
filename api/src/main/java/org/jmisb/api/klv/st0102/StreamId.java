 ...
 *
 * <p>This was historically used to link specific security markings to particular streams.
 *
 ...
 * </blockquote>
 *
 * <p>StreamId should not be used in newly generated files, and is not valid as of ST0102.12. It is
 * provided for backwards compatibility only. As such, there is no value-based constructor for this
 * class.
 */
