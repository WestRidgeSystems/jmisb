...
public enum Group
{
    ...
    /** Variable Length Packs eliminate the key field and instead use a defined sequence of data elements */
    VARIABLE_LENGTH_PACK,

    /** Defined Length Packs eliminate both key and length fields and use pre-defined lengths for all elements */
    DEFINED_LENGTH_PACK;
}
