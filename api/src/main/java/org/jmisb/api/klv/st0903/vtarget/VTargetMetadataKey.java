...
public enum VTargetMetadataKey {
    ...
    TargetCentroid(1),
    /**
     * Position in pixels of the top left corner of the target bounding box within the Motion
     * Imagery Frame.
     */
    BoundaryTopLeft(2),
    /**
     * Position in pixels of the bottom right corner of the target bounding box within the Motion
     * Imagery Frame.
     */
    ...
    TargetHistory(6),
    /**
     * Percentage of pixels within the bounding box detected to be target pixels rather than
     * background pixels.
     */
    ...
    TargetIntensity(9),
    /** Latitude offset for target from frame center latitude (used with MISB ST 0601). */
    TargetLocationOffsetLat(10),
    /** Longitude offset for target from frame center longitude (used with MISB ST 0601). */
    ...
    /**
     * Location of the target (latitude, longitude and height above WGS84 Ellipsoid), with sigma and
     * rho values.
     */
    TargetLocation(17),
    ...
    /**
     * Specifies the column and the row of a sensor Focal Plane Array (FPA) in a two-dimensional
     * array of FPAs.
     */
    FPAIndex(21),
    /** Identifier indicating which algorithm in Algorithm Series detected this target. */
    AlgorithmId(22),
