 ...
 * <p>
 * The OntologyId is an alternative method for specifying the information in Tag
 * 1 (Ontology) and Tag 2 (OntologyClass) when the VMTI LS includes an Ontology
 * Series in Tag 103. The OntologyId is a reference to one of the elements in
 * the VMTI LS Ontology Series. The 103_ontologySeries attribute lists all the
 * ontologies the VMTI LS will use. Each ontology in the series includes an
 * identifier (Id), the OntologyId value equals one of the Id values in the
