 ...
 * From ST0903:
 * <blockquote>
 * Longitude offset for top left corner of target bounding box from Frame Center
 * Longitude (MISB ST 0601), based on WGS84 ellipsoid. Use with Frame Center
 * Longitude. Added to the Frame Center Longitude from the parent ST 0601 packet
 * to determine the Longitude of the top left corner of the target bounding box.
