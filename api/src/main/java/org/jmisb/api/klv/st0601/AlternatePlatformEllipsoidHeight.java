 ...
 * <p>
 * The Alternate Platform Ellipsoid Height is the vertical distance between the
 * sensor and the WGS84 Reference Ellipsoid. Measurement is GPS derived.
 * <p>
 * An alternate platform is an airborne or ground based platform that is connected
 * via direct datalink to a UAS generating Motion Imagery and metadata.
 * <p>
