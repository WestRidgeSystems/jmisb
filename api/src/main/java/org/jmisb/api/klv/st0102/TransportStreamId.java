 ...
 *
 * <p>This was historically used to link specific security markings to particular transport streams.
 *
 ...
 * </blockquote>
 *
 * <p>TransportStreamId should not be used in newly generated files, and is not valid as of
    ...
    public TransportStreamId(byte[] bytes) {
        if (bytes.length != 2) {
            throw new IllegalArgumentException(
                    "Transport Stream ID encoding is a two-byte unsigned int");
        }
