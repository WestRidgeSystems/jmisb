...
public class VideoDateRateTest
{
    ...
    public void testConstructFromValue()
    {
        ...
        assertEquals(rate.getBytes(), new byte[]{(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00});

        // Max
        rate = new VideoDataRate(4294967295L);
        assertEquals(rate.getBytes(), new byte[]{(byte)0xff, (byte)0xff, (byte)0xff, (byte)0xff});

        rate = new VideoDataRate(159);
        assertEquals(rate.getBytes(), new byte[]{(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x9f});
    ...
    {
        // Min
        VideoDataRate rate = new VideoDataRate(new byte[]{(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00});
