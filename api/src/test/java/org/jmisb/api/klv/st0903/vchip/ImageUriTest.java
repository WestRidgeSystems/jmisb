...
public class ImageUriTest
{
    ...
    public void testImageUri()
    {
        ...
        final byte[] bytes = new byte[]{0x68, 0x74, 0x74, 0x70, 0x73, 0x3A, 0x2F, 0x2F, 0x77, 0x77, 0x77, 0x2E, 0x67, 0x77, 0x67, 0x2E, 0x6E, 0x67, 0x61, 0x2E, 0x6D, 0x69, 0x6C, 0x2F, 0x6D, 0x69, 0x73, 0x62, 0x2F, 0x69, 0x6D, 0x61, 0x67, 0x65, 0x73, 0x2F, 0x62, 0x61, 0x6E, 0x6E, 0x65, 0x72, 0x2E, 0x6A, 0x70, 0x67};
        ...
        Assert.assertEquals(string.getDisplayableValue(), "https://www.gwg.nga.mil/misb/images/banner.jpg");
        Assert.assertEquals(stringFromBytes.getValue(), stringVal);
        Assert.assertEquals(stringFromBytes.getDisplayableValue(), "https://www.gwg.nga.mil/misb/images/banner.jpg");
    }
    ...
    public void testImageUriFromURI() throws URISyntaxException
    {
        ...
        Assert.assertEquals(string.getBytes(), bytes);
        Assert.assertEquals(string.getDisplayableValue(), "https://www.gwg.nga.mil/misb/images/banner.jpg");
        Assert.assertEquals(stringFromBytes.getValue(), "https://www.gwg.nga.mil/misb/images/banner.jpg");
        Assert.assertEquals(stringFromBytes.getDisplayableValue(), "https://www.gwg.nga.mil/misb/images/banner.jpg");
    }
    ...
    public void testFactoryImageUri() throws KlvParseException, URISyntaxException
    {
        ...
        Assert.assertEquals(uri.getDisplayableValue(), "https://www.gwg.nga.mil/misb/images/banner.jpg");
        Assert.assertEquals(uri.getUri(), new URI("https://www.gwg.nga.mil/misb/images/banner.jpg"));
    }
}
