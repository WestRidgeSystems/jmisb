...
public class TargetLocationOffsetLonTest {
    ...
    {
        TargetLocationOffsetLon offset = new TargetLocationOffsetLon(new byte[]{(byte)0x3A, (byte)0x66, (byte)0x67});
        assertEquals(offset.getBytes(), new byte[]{(byte)0x3A, (byte)0x66, (byte)0x67});
        assertEquals(offset.getDisplayName(), "Target Location Offset Longitude");
        assertEquals(offset.getDisplayableValue(), "10.00000\u00B0");
        assertEquals(offset.getValue(), 10.0);
    ...
    {
        IVmtiMetadataValue value = VTargetPack.createValue(VTargetMetadataKey.TargetLocationOffsetLon, new byte[]{(byte)0x3A, (byte)0x66, (byte)0x67});
    ...
    {
        new TargetLocationOffsetLon(new byte[]{0x01, 0x02});
    }
}
