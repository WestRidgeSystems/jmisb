...
public class OnBoardMiStoragePercentFullTest {
    ...
    public void testConstructFromEncoded() {
        // From ST:
        OnBoardMiStoragePercentFull percent =
                new OnBoardMiStoragePercentFull(new byte[] {(byte) 0x48, (byte) 0x00});
    ...
    public void testFactory() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.OnBoardMiStoragePercentFull, bytes);
