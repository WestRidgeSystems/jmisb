...
public class SensorLatitudeTest
{
    ...
    {
        // Min
        SensorLatitude latitude = new SensorLatitude(new byte[]{(byte)0x80, (byte)0x00, (byte)0x00, (byte)0x01});
        Assert.assertEquals(latitude.getDegrees(), -90.0);
        Assert.assertEquals(latitude.getBytes(), new byte[]{(byte)0x80, (byte)0x00, (byte)0x00, (byte)0x01});

        // Max
        latitude = new SensorLatitude(new byte[]{(byte)0x7f, (byte)0xff, (byte)0xff, (byte)0xff});
        Assert.assertEquals(latitude.getDegrees(), 90.0);
        Assert.assertEquals(latitude.getBytes(), new byte[]{(byte)0x7f, (byte)0xff, (byte)0xff, (byte)0xff});

        // Zero
        latitude = new SensorLatitude(new byte[]{(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00});
        Assert.assertEquals(latitude.getDegrees(), 0.0);
        Assert.assertEquals(latitude.getBytes(), new byte[]{(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00});
        ...
        latitude = new SensorLatitude(new byte[]{(byte)0x55, (byte)0x95, (byte)0xb6, (byte)0x6d});
