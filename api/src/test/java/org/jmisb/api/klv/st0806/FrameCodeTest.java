...
public class FrameCodeTest
{
    ...
    public void testConstructFromValue()
    {
        ...
        assertEquals(code.getBytes(), new byte[]{(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00});

        // Max
        code = new FrameCode(4294967295L);
        assertEquals(code.getBytes(), new byte[]{(byte)0xff, (byte)0xff, (byte)0xff, (byte)0xff});

        code = new FrameCode(159);
        assertEquals(code.getBytes(), new byte[]{(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x9f});
    ...
    {
        // Min
        FrameCode code = new FrameCode(new byte[]{(byte)0x00, (byte)0x00, (byte)0x00, (byte)0x00});
