 ...
 *
 * <p>This does a lot of the broader checks for PixelValue superclass too.
 */
public class TargetCentroidTest {
    ...
    public void testConstructFromEncodedBytes() {
        TargetCentroid index =
                new TargetCentroid(new byte[] {(byte) 0x06, (byte) 0x40, (byte) 0x00});
        assertEquals(index.getBytes(), new byte[] {(byte) 0x06, (byte) 0x40, (byte) 0x00});
        assertEquals(index.getDisplayName(), "Target Centroid");
        assertEquals(index.getDisplayableValue(), "409600");
        assertEquals(index.getPixelNumber(), 409600L);
    ...
    public void testConstructFromEncodedBytes65536() {
        TargetCentroid index =
                new TargetCentroid(new byte[] {(byte) 0x01, (byte) 0x00, (byte) 0x00});
    ...
    public void testConstructFromEncodedBytes16777215() {
        TargetCentroid index =
                new TargetCentroid(new byte[] {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF});
    ...
    public void testConstructFromEncodedBytes16777216() {
        TargetCentroid index =
                new TargetCentroid(new byte[] {(byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x00});
        assertEquals(
                index.getBytes(), new byte[] {(byte) 0x01, (byte) 0x00, (byte) 0x00, (byte) 0x00});
        assertEquals(index.getDisplayName(), "Target Centroid");
    ...
    public void testConstructFromEncodedBytes4294967295() {
        TargetCentroid index =
                new TargetCentroid(new byte[] {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF});
        assertEquals(
                index.getBytes(), new byte[] {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF, (byte) 0xFF});
        assertEquals(index.getDisplayName(), "Target Centroid");
