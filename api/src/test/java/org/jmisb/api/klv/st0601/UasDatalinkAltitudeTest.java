...
public class UasDatalinkAltitudeTest {
    ...
    public void testFactoryFrameCenterElevation() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.FrameCenterElevation, bytes);
    ...
    public void testFactoryAirfieldElevation() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.AirfieldElevation, bytes);
    ...
    public void testFactoryAlternatePlatformAltitude() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.AlternatePlatformAltitude, bytes);
    ...
    public void testFactoryTargetLocationElevation() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.TargetLocationElevation, bytes);
    ...
    public void testSensorEllipsoidHeight() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.SensorEllipsoidHeight, bytes);
    ...
    public void testAlternatePlatformEllipsoidHeight() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(
                        UasDatalinkTag.AlternatePlatformEllipsoidHeight, bytes);
