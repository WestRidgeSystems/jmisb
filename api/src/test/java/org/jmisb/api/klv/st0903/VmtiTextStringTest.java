...
public class VmtiTextStringTest
{
    ...
    {
        VmtiTextString systemName = new VmtiTextString(VmtiTextString.SYSTEM_NAME, "DSTO_ADSS_VMTI");
    ...
    {
        VmtiTextString systemName = new VmtiTextString(VmtiTextString.SYSTEM_NAME, new byte[]{(byte)0x44, (byte)0x53, (byte)0x54, (byte)0x4F, (byte)0x5F, (byte)0x41, (byte)0x44, (byte)0x53, (byte)0x53, (byte)0x5F, (byte)0x56, (byte)0x4D, (byte)0x54, (byte)0x49});
        assertEquals(systemName.getBytes(), new byte[]{(byte)0x44, (byte)0x53, (byte)0x54, (byte)0x4F, (byte)0x5F, (byte)0x41, (byte)0x44, (byte)0x53, (byte)0x53, (byte)0x5F, (byte)0x56, (byte)0x4D, (byte)0x54, (byte)0x49});
        assertEquals(systemName.getDisplayName(), "System Name/Description");
        assertEquals(systemName.getDisplayableValue(), "DSTO_ADSS_VMTI");
        assertEquals(systemName.getValue(), "DSTO_ADSS_VMTI");
    ...
    {
        VmtiTextString sourceSensor = new VmtiTextString(VmtiTextString.SOURCE_SENSOR, new byte[]{(byte)0x45, (byte)0x4F, (byte)0x20, (byte)0x4E, (byte)0x6F, (byte)0x73, (byte)0x65});
        assertEquals(sourceSensor.getBytes(), new byte[]{(byte)0x45, (byte)0x4F, (byte)0x20, (byte)0x4E, (byte)0x6F, (byte)0x73, (byte)0x65});
        assertEquals(sourceSensor.getDisplayName(), "Source Sensor");
        assertEquals(sourceSensor.getDisplayableValue(), "EO Nose");
        assertEquals(sourceSensor.getValue(), "EO Nose");
