...
public class OntologySeriesTest
{
    ...
    private final byte[] twoOntologysBytes = new byte[]
    {
    ...
    public void setUpMethod() throws Exception
    {
        ...
        VmtiUri ontology = new VmtiUri(VmtiUri.ONTOLOGY, "https://raw.githubusercontent.com/owlcs/pizza-ontology/master/pizza.owl");
    ...
    {
        IVmtiMetadataValue value = VmtiLocalSet.createValue(VmtiMetadataKey.OntologySeries, twoOntologysBytes);
        assertNotNull(value);
