...
public class NestedRvtLocalSetTest
{
    ...
    {
        IUasDatalinkValue value = UasDatalinkFactory.createValue(UasDatalinkTag.RvtLocalDataSet, localSetAsByteArray);
    ...
    private void checkLocalSetValues(NestedRvtLocalSet localSet) {
        ...
        Assert.assertEquals(localSet.getRVT().getField(RvtMetadataKey.UASLSVersionNumber).getDisplayableValue(), "ST0806.4");
