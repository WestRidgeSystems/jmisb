...
public class VChipLSTest extends LoggerChecks {
    ...
    public void parseTag2() throws KlvParseException, URISyntaxException {
        final byte[] bytes =
                new byte[] {
                    0x02, 46, 0x68, 0x74, 0x74, 0x70, 0x73, 0x3A, 0x2F, 0x2F, 0x77, 0x77, 0x77,
                    0x2E, 0x67, 0x77, 0x67, 0x2E, 0x6E, 0x67, 0x61, 0x2E, 0x6D, 0x69, 0x6C, 0x2F,
                    0x6D, 0x69, 0x73, 0x62, 0x2F, 0x69, 0x6D, 0x61, 0x67, 0x65, 0x73, 0x2F, 0x62,
                    0x61, 0x6E, 0x6E, 0x65, 0x72, 0x2E, 0x6A, 0x70, 0x67
                };
        VChipLS vChipLS = new VChipLS(bytes, 0, bytes.length);
        assertNotNull(vChipLS);
        assertEquals(vChipLS.getTags().size(), 1);
    ...
    public void parseTag1andTag2() throws KlvParseException, URISyntaxException {
        final byte[] bytes =
                new byte[] {
                    0x01, 0x04, 0x6A, 0x70, 0x65, 0x67, 0x02, 46, 0x68, 0x74, 0x74, 0x70, 0x73,
                    0x3A, 0x2F, 0x2F, 0x77, 0x77, 0x77, 0x2E, 0x67, 0x77, 0x67, 0x2E, 0x6E, 0x67,
                    0x61, 0x2E, 0x6D, 0x69, 0x6C, 0x2F, 0x6D, 0x69, 0x73, 0x62, 0x2F, 0x69, 0x6D,
                    0x61, 0x67, 0x65, 0x73, 0x2F, 0x62, 0x61, 0x6E, 0x6E, 0x65, 0x72, 0x2E, 0x6A,
                    0x70, 0x67
                };
        VChipLS vChipLS = new VChipLS(bytes, 0, bytes.length);
        assertNotNull(vChipLS);
