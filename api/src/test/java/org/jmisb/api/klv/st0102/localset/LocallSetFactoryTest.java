 ...
 * 
 * Note: you shouldn't use these unit tests for what a valid field value is
 * within the US way of doing security markings.
 */
public class LocallSetFactoryTest
{
    ...
    {
        byte[] bytes = new byte[]{(byte)0x53, (byte)0x43, (byte)0x47, (byte)0x44, (byte)0x20, (byte)0x66, (byte)0x6f, (byte)0x72, (byte)0x20, (byte)0x53, (byte)0x79, (byte)0x73, (byte)0x74, (byte)0x65, (byte)0x6d, (byte)0x20, (byte)0x58};
        ISecurityMetadataValue value = LocalSetFactory.createValue(SecurityMetadataKey.ClassifiedBy, bytes);
    ...
    {
        byte[] bytes = new byte[]{(byte)0x4d, (byte)0x75, (byte)0x6c, (byte)0x74, (byte)0x69, (byte)0x70, (byte)0x6c, (byte)0x65, (byte)0x20, (byte)0x53, (byte)0x6f, (byte)0x75, (byte)0x72, (byte)0x63, (byte)0x65, (byte)0x73};
        ISecurityMetadataValue value = LocalSetFactory.createValue(SecurityMetadataKey.DerivedFrom, bytes);
        Assert.assertTrue(value instanceof SecurityMetadataString);
    ...
    {
        byte[] bytes = new byte[]{(byte)0x4d, (byte)0x75, (byte)0x6c, (byte)0x74, (byte)0x69, (byte)0x70, (byte)0x6c, (byte)0x65, (byte)0x20, (byte)0x53, (byte)0x6f, (byte)0x75, (byte)0x72, (byte)0x63, (byte)0x65, (byte)0x73};
        ISecurityMetadataValue value = LocalSetFactory.createValue(SecurityMetadataKey.ClassificationReason, bytes);
        Assert.assertTrue(value instanceof SecurityMetadataString);
    ...
    {
        byte[] bytes = new byte[]{(byte)0x41, (byte)0x75, (byte)0x73, (byte)0x74, (byte)0x72, (byte)0x61, (byte)0x6c, (byte)0x69, (byte)0x61, (byte)0x6e, (byte)0x20, (byte)0x50, (byte)0x53, (byte)0x50, (byte)0x46};
        ISecurityMetadataValue value = LocalSetFactory.createValue(SecurityMetadataKey.MarkingSystem, bytes);
        Assert.assertTrue(value instanceof SecurityMetadataString);
    ...
    {
        byte[] bytes = new byte[]{(byte)0x42, (byte)0x6f, (byte)0x62, (byte)0x21, (byte)0x20, (byte)0x57, (byte)0x65, (byte)0x20, (byte)0x6c, (byte)0x69, (byte)0x6b, (byte)0x65, (byte)0x20, (byte)0x42, (byte)0x6f, (byte)0x62, (byte)0x2e, (byte)0x2e, (byte)0x2e};
        ISecurityMetadataValue value = LocalSetFactory.createValue(SecurityMetadataKey.ClassificationComments, bytes);
        Assert.assertTrue(value instanceof SecurityMetadataString);
    ...
    public void testDeclassificationDateCreate()
    {
        ...
        ISecurityMetadataValue value = LocalSetFactory.createValue(SecurityMetadataKey.DeclassificationDate, bytes);
    ...
    public void testCcmDateCreate()
    {
        ...
        ISecurityMetadataValue value = LocalSetFactory.createValue(SecurityMetadataKey.CcCodingMethodVersionDate, bytes);
        ...
        assertEquals(bytesOut, new byte[]{0x32, 0x30, 0x32, 0x30, 0x2d, 0x30, 0x34, 0x2d, 0x32, 0x35});
    ...
    public void testOcmDateCreate()
    {
        ...
        ISecurityMetadataValue value = LocalSetFactory.createValue(SecurityMetadataKey.OcCodingMethodVersionDate, bytes);
