...
public class BoundaryTopLeftLatOffsetTest {
    ...
    {
        BoundaryTopLeftLatOffset offset = new BoundaryTopLeftLatOffset(new byte[]{(byte)0x3A, (byte)0x66, (byte)0x67});
        assertEquals(offset.getBytes(), new byte[]{(byte)0x3A, (byte)0x66, (byte)0x67});
        assertEquals(offset.getDisplayName(), "Boundary Top Left Lat Offset");
        assertEquals(offset.getDisplayableValue(), "10.00000\u00B0");
        assertEquals(offset.getValue(), 10.0);
    ...
    {
        IVmtiMetadataValue value = VTargetPack.createValue(VTargetMetadataKey.BoundaryTopLeftLatOffset, new byte[]{(byte)0x3A, (byte)0x66, (byte)0x67});
    ...
    {
        new BoundaryTopLeftLatOffset(new byte[]{0x01, 0x02});
    }
}
