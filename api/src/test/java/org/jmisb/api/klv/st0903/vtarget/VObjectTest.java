...
public class VObjectTest
{
    ...
    {
        IVmtiMetadataValue value = VTargetPack.createValue(VTargetMetadataKey.VObject, ontologyBytes);
    ...
    public void constructFromValue() throws KlvParseException, URISyntaxException
    {
        ...
        IVmtiMetadataValue imageType = VObjectLS.createValue(VObjectMetadataKey.ontology, ontologyBytes);
