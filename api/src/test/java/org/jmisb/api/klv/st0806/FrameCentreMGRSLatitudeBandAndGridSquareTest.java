...
public class FrameCentreMGRSLatitudeBandAndGridSquareTest
{
    ...
    {
        FrameCentreMGRSLatitudeBandAndGridSquare locAndGridSquare = new FrameCentreMGRSLatitudeBandAndGridSquare("QFJ");
        assertEquals(locAndGridSquare.getBytes(), new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(locAndGridSquare.getDisplayName(), "Frame Center MGRS Latitude Band and Grid Square");
    ...
    {
        FrameCentreMGRSLatitudeBandAndGridSquare locAndGridSquare = new FrameCentreMGRSLatitudeBandAndGridSquare(new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(locAndGridSquare.getDisplayableValue(), "QFJ");
        assertEquals(locAndGridSquare.getBytes(), new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(locAndGridSquare.getDisplayName(), "Frame Center MGRS Latitude Band and Grid Square");
        assertEquals(locAndGridSquare.getLatitudeBand(), "Q");
    ...
    public void testFactory() throws KlvParseException
    {
        ...
        IRvtMetadataValue v = RvtLocalSet.createValue(RvtMetadataKey.MGRSLatitudeBandAndGridSquareSecondValue, bytes);
        assertTrue(v instanceof FrameCentreMGRSLatitudeBandAndGridSquare);
        FrameCentreMGRSLatitudeBandAndGridSquare locAndGridSquare = (FrameCentreMGRSLatitudeBandAndGridSquare)v;
        assertEquals(locAndGridSquare.getBytes(), new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(locAndGridSquare.getDisplayableValue(), "QFJ");
        assertEquals(locAndGridSquare.getDisplayName(), "Frame Center MGRS Latitude Band and Grid Square");
        assertEquals(locAndGridSquare.getLatitudeBand(), "Q");
