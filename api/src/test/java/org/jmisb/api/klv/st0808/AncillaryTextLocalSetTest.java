...
public class AncillaryTextLocalSetTest extends LoggerChecks {
    ...
    public void createFromValues() throws KlvParseException {
        final Map<AncillaryTextMetadataKey, IAncillaryTextMetadataValue> values = new HashMap<>();
        values.put(AncillaryTextMetadataKey.Originator, new Originator("Author 1"));
        values.put(
                AncillaryTextMetadataKey.PrecisionTimeStamp,
                new PrecisionTimeStamp(1112376654453100L));
        values.put(AncillaryTextMetadataKey.MessageBody, new MessageBody("Message 1"));
        values.put(AncillaryTextMetadataKey.Source, new Source("Test Chat Room"));
        values.put(
                AncillaryTextMetadataKey.MessageCreationTime,
                new MessageCreationTime(1112376654453100L));
    ...
    public void constructUnknown() throws KlvParseException {
        ...
        IAncillaryTextMetadataValue unknown =
                AncillaryTextLocalSet.createValue(
                        AncillaryTextMetadataKey.Undefined, new byte[] {0x01, 0x02});
        this.verifySingleLoggerMessage("Unknown Ancillary Text Metadata tag: Undefined");
        assertNull(unknown);
    }
}
