...
public class PoiAoiTextStringTest
{
    ...
    {
        RvtPoiAoiTextString textString = new RvtPoiAoiTextString(RvtPoiAoiTextString.POI_AOI_TEXT, "QFJ");
    ...
    {
        RvtPoiAoiTextString textString = new RvtPoiAoiTextString(RvtPoiAoiTextString.POI_AOI_TEXT, new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(textString.getDisplayableValue(), "QFJ");
        assertEquals(textString.getBytes(), new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(textString.getDisplayName(), "POI/AOI Text");
    }
    ...
    {
        byte[] bytes = new byte[]{(byte)0x52, (byte)0x4F, (byte)0x5A, (byte)0x20, (byte)0x46, (byte)0x55};
        IRvtPoiAoiMetadataValue v = RvtAoiLocalSet.createValue(RvtAoiMetadataKey.PoiAoiText, bytes);
        assertTrue(v instanceof RvtPoiAoiTextString);
        RvtPoiAoiTextString textString = (RvtPoiAoiTextString)v;
        assertEquals(textString.getBytes(), new byte[]{(byte)0x52, (byte)0x4F, (byte)0x5A, (byte)0x20, (byte)0x46, (byte)0x55});
    ...
    public void testFactorySourceIcon() throws KlvParseException
    {
        ...
        IRvtPoiAoiMetadataValue v = RvtPoiLocalSet.createValue(RvtPoiMetadataKey.PoiSourceIcon, bytes);
        assertTrue(v instanceof RvtPoiAoiTextString);
        RvtPoiAoiTextString textString = (RvtPoiAoiTextString)v;
    ...
    public void testFactorySourceID() throws KlvParseException
    {
        ...
        IRvtPoiAoiMetadataValue v = RvtPoiLocalSet.createValue(RvtPoiMetadataKey.PoiAoiSourceId, bytes);
        assertTrue(v instanceof RvtPoiAoiTextString);
        RvtPoiAoiTextString textString = (RvtPoiAoiTextString)v;
    ...
    public void testFactorySourceIDAoi() throws KlvParseException
    {
        ...
        IRvtPoiAoiMetadataValue v = RvtAoiLocalSet.createValue(RvtAoiMetadataKey.PoiAoiSourceId, bytes);
        assertTrue(v instanceof RvtPoiAoiTextString);
        RvtPoiAoiTextString textString = (RvtPoiAoiTextString)v;
        assertEquals(textString.getBytes(), new byte[]{(byte)0x41, (byte)0x31, (byte)0x32, (byte)0x33, (byte)0x34});
    ...
    public void testFactoryPoiAoiLabel() throws KlvParseException
    {
        ...
        IRvtPoiAoiMetadataValue v = RvtPoiLocalSet.createValue(RvtPoiMetadataKey.PoiAoiLabel, bytes);
        assertTrue(v instanceof RvtPoiAoiTextString);
        RvtPoiAoiTextString textString = (RvtPoiAoiTextString)v;
    ...
    public void testFactoryPoiAoiLabelAoi() throws KlvParseException
    {
        ...
        IRvtPoiAoiMetadataValue v = RvtAoiLocalSet.createValue(RvtAoiMetadataKey.PoiAoiLabel, bytes);
        assertTrue(v instanceof RvtPoiAoiTextString);
        RvtPoiAoiTextString textString = (RvtPoiAoiTextString)v;
    ...
    public void testFactoryOperationID() throws KlvParseException
    {
        ...
        IRvtPoiAoiMetadataValue v = RvtPoiLocalSet.createValue(RvtPoiMetadataKey.OperationId, bytes);
        assertTrue(v instanceof RvtPoiAoiTextString);
        RvtPoiAoiTextString textString = (RvtPoiAoiTextString)v;
    ...
    {
        byte[] bytes = new byte[]{(byte)0x4F, (byte)0x50, (byte)0x20, (byte)0x53, (byte)0x6F, (byte)0x6C};
        IRvtPoiAoiMetadataValue v = RvtAoiLocalSet.createValue(RvtAoiMetadataKey.OperationId, bytes);
        assertTrue(v instanceof RvtPoiAoiTextString);
        RvtPoiAoiTextString textString = (RvtPoiAoiTextString)v;
        assertEquals(textString.getBytes(), new byte[]{(byte)0x4F, (byte)0x50, (byte)0x20, (byte)0x53, (byte)0x6F, (byte)0x6C});
        assertEquals(textString.getDisplayableValue(), "OP Sol");
