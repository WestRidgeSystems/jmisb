...
public class AircraftMGRSLatitudeBandAndGridSquareTest
{
    ...
    {
        AircraftMGRSLatitudeBandAndGridSquare locAndGridSquare = new AircraftMGRSLatitudeBandAndGridSquare("QFJ");
        assertEquals(locAndGridSquare.getBytes(), new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(locAndGridSquare.getDisplayName(), "Aircraft MGRS Latitude Band and Grid Square");
    ...
    {
        AircraftMGRSLatitudeBandAndGridSquare locAndGridSquare = new AircraftMGRSLatitudeBandAndGridSquare(new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(locAndGridSquare.getDisplayableValue(), "QFJ");
        assertEquals(locAndGridSquare.getBytes(), new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(locAndGridSquare.getDisplayName(), "Aircraft MGRS Latitude Band and Grid Square");
        assertEquals(locAndGridSquare.getLatitudeBand(), "Q");
    ...
    public void testFactory() throws KlvParseException
    {
        ...
        IRvtMetadataValue v = RvtLocalSet.createValue(RvtMetadataKey.MGRSLatitudeBandAndGridSquare, bytes);
        assertTrue(v instanceof AircraftMGRSLatitudeBandAndGridSquare);
        AircraftMGRSLatitudeBandAndGridSquare locAndGridSquare = (AircraftMGRSLatitudeBandAndGridSquare)v;
        assertEquals(locAndGridSquare.getBytes(), new byte[]{(byte)0x51, (byte)0x46, (byte)0x4A});
        assertEquals(locAndGridSquare.getDisplayableValue(), "QFJ");
        assertEquals(locAndGridSquare.getDisplayName(), "Aircraft MGRS Latitude Band and Grid Square");
        assertEquals(locAndGridSquare.getLatitudeBand(), "Q");
