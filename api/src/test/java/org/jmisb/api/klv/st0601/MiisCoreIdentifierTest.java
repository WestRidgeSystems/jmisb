...
public class MiisCoreIdentifierTest {
    ...
    private static final String ST_EXAMPLE_TEXT =
    ...
    public void verifyFromFactory() throws KlvParseException {
        // ST0601 example
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.MiisCoreIdentifier, ST_EXAMPLE_BYTES);
    ...
    public void verifyBadCoreIdentifierHandling() throws KlvParseException {
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(
                        UasDatalinkTag.MiisCoreIdentifier, new byte[] {0x01, 0x10, 0x00});
        Assert.assertTrue(v instanceof MiisCoreIdentifier);
        MiisCoreIdentifier identifier = (MiisCoreIdentifier) v;
