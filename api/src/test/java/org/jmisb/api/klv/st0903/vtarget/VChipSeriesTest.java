...
{
    final byte[] bytesOneChip = new byte[]
    {
        78, // composite length
    ...
    final byte[] bytesTwoChips = new byte[]
    {
    ...
    {
        IVmtiMetadataValue value = VTargetPack.createValue(VTargetMetadataKey.VChipSeries , bytesOneChip);
    ...
    {
        IVmtiMetadataValue value = VTargetPack.createValue(VTargetMetadataKey.VChipSeries , bytesTwoChips);
        assertTrue(value instanceof VChipSeries );
        VChipSeries chipSeries = (VChipSeries)value;
        // Content can vary, but length should be OK.
