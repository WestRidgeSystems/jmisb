...
public class PlatformVerticalSpeedTest
{
    ...
    public void testOutOfRange()
    {
        ...
        PlatformVerticalSpeed platformVerticalSpeed = new PlatformVerticalSpeed(Double.POSITIVE_INFINITY);
    ...
    public void testFactory() throws KlvParseException {
        ...
        IUasDatalinkValue v = UasDatalinkFactory.createValue(UasDatalinkTag.PlatformVerticalSpeed, bytes);
