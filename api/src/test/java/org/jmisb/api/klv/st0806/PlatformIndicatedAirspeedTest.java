...
public class PlatformIndicatedAirspeedTest
{
    ...
    {
        // Min
        RvtPlatformIndicatedAirspeed speed = new RvtPlatformIndicatedAirspeed(new byte[]{(byte)0x00, (byte)0x00});
    ...
    public void testFactory() throws KlvParseException
    {
        ...
        IRvtMetadataValue v = RvtLocalSet.createValue(RvtMetadataKey.PlatformIndicatedAirspeed, bytes);
