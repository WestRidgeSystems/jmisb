...
public class TargetHistoryTest {
    ...
    {
        IVmtiMetadataValue value = VTargetPack.createValue(VTargetMetadataKey.TargetHistory, new byte[]{(byte)0x0A, (byte)0xCD});
    ...
    {
        IVmtiMetadataValue value = VTargetPack.createValue(VTargetMetadataKey.TargetHistory, new byte[]{(byte)0x00});
        assertTrue(value instanceof TargetHistory);
        TargetHistory history = (TargetHistory)value;
        assertEquals(history.getBytes(), new byte[]{(byte)0x00});
        assertEquals(history.getDisplayName(), "Target History");
    ...
    {
        IVmtiMetadataValue value = VTargetPack.createValue(VTargetMetadataKey.TargetHistory, new byte[]{(byte)0xFF, (byte)0xFF});
        assertTrue(value instanceof TargetHistory);
        TargetHistory history = (TargetHistory)value;
