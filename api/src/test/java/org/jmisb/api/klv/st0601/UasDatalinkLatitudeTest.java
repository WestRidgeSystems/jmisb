...
public class UasDatalinkLatitudeTest {
    ...
    public void testSubClasses() {
        ...
        Assert.assertEquals(
                latitude.getBytes(),
                new byte[] {(byte) 0xf1, (byte) 0x01, (byte) 0xa2, (byte) 0x29});
        ...
        Assert.assertEquals(
                latitude.getBytes(),
                new byte[] {(byte) 0x8f, (byte) 0x69, (byte) 0x52, (byte) 0x62});
        ...
        Assert.assertEquals(
                latitude.getBytes(),
                new byte[] {(byte) 0xf0, (byte) 0xf4, (byte) 0x12, (byte) 0x44});
        ...
        latitude =
                new FullCornerLatitude(
                        new byte[] {(byte) 0xf0, (byte) 0xf4, (byte) 0x12, (byte) 0x44},
                        FullCornerLatitude.CORNER_LAT_1);
    ...
    public void testFactoryAlternatePlatformLatitude() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.AlternatePlatformLatitude, bytes);
    ...
    public void testFactoryFrameCenterLatitude() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.FrameCenterLatitude, bytes);
    ...
    public void testFactoryTargetLocationLatitude() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.TargetLocationLatitude, bytes);
