...
public class UasDatalinkLongitudeTest {
    ...
    public void testSubClasses() {
        ...
        Assert.assertEquals(
                longitude.getBytes(),
                new byte[] {(byte) 0x00, (byte) 0x1c, (byte) 0x50, (byte) 0x1c});
        ...
        longitude =
                new AlternatePlatformLongitude(
                        new byte[] {(byte) 0x00, (byte) 0x1c, (byte) 0x50, (byte) 0x1c});
        ...
        Assert.assertEquals(
                longitude.getBytes(),
                new byte[] {(byte) 0x14, (byte) 0xbc, (byte) 0x08, (byte) 0x2b});
        ...
        Assert.assertEquals(
                longitude.getBytes(),
                new byte[] {(byte) 0x76, (byte) 0x54, (byte) 0x57, (byte) 0xf2});
        ...
        Assert.assertEquals(
                longitude.getBytes(),
                new byte[] {(byte) 0x14, (byte) 0xb6, (byte) 0x79, (byte) 0xb9});
        ...
        longitude =
                new FullCornerLongitude(
                        new byte[] {(byte) 0x14, (byte) 0xb6, (byte) 0x79, (byte) 0xb9},
                        FullCornerLongitude.CORNER_LON_1);
    ...
    public void testFactoryAlternatePlatformLongitude() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.AlternatePlatformLongitude, bytes);
    ...
    public void testFactoryFrameCenterLongitude() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.FrameCenterLongitude, bytes);
    ...
    public void testFactoryTargetLocationLongitude() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.TargetLocationLongitude, bytes);
