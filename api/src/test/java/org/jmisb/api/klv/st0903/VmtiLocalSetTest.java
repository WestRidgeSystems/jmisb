...
public class VmtiLocalSetTest extends LoggerChecks {
    ...
    public void parseTagsWithChecksum() throws KlvParseException {
        final byte[] bytes =
                new byte[] {
                    0x03, 0x0E, 0x44, 0x53, 0x54, 0x4F, 0x5F, 0x41, 0x44, 0x53, 0x53, 0x5F, 0x56,
                    0x4D, 0x54, 0x49, 0x04, 0x01, 0x04, 0x01, 0x02, 0x47, 0x3b
                };
        VmtiLocalSet localSet = new VmtiLocalSet(bytes);
        assertNotNull(localSet);
        assertEquals(localSet.getIdentifiers().size(), 2);
    ...
    public void parseTagsWithChecksumBad1() throws KlvParseException, URISyntaxException {
        final byte[] bytes =
                new byte[] {
                    0x03, 0x0E, 0x44, 0x53, 0x54, 0x4F, 0x5F, 0x41, 0x44, 0x53, 0x53, 0x5F, 0x56,
                    0x4D, 0x54, 0x49, 0x04, 0x01, 0x04, 0x01, 0x02, 0x46, 0x3b
                };
    ...
    public void parseTagsWithChecksumBad2() throws KlvParseException, URISyntaxException {
        final byte[] bytes =
                new byte[] {
                    0x03, 0x0E, 0x44, 0x53, 0x54, 0x4F, 0x5F, 0x41, 0x44, 0x53, 0x53, 0x5F, 0x56,
                    0x4D, 0x54, 0x49, 0x04, 0x01, 0x04, 0x01, 0x02, 0x47, 0x3c
                };
        new VmtiLocalSet(bytes);
    }
        ...
        assertEquals(
                ...
                new byte[] {
                    (byte) 0x06, (byte) 0x0E, (byte) 0x2B, (byte) 0x34, (byte) 0x02, (byte) 0x0B,
                            (byte) 0x01, (byte) 0x01,
                    (byte) 0x0E, (byte) 0x01, (byte) 0x03, (byte) 0x03, (byte) 0x06, (byte) 0x00,
                            (byte) 0x00, (byte) 0x00
                });
    }
    ...
    public void constructFromMapNonNestedWithChecksum() {
        ...
        IVmtiMetadataValue fakeChecksum =
                new IVmtiMetadataValue() {
                    @Override
