...
{
    private final byte[] localSetAsBytes = new byte[]{(byte)0x05, (byte)0x05, (byte)0x54, (byte)0x65, (byte)0x73, (byte)0x54, (byte)0x31};
    ...
    {
        IUasDatalinkValue value = UasDatalinkFactory.createValue(UasDatalinkTag.SecurityLocalMetadataSet, localSetAsBytes);
