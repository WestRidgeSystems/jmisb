...
import org.jmisb.st0102.SecurityMetadataMessage;
...
public class SecurityMetadataLocalSet extends SecurityMetadataMessage {
    ...
    public static class Builder {
         ...
         * {@link org.jmisb.st0102.CountryCodingMethod#GENC_TWO_LETTER} will be used as a default
         * value.
         *
         ...
         * org.jmisb.st0102.CountryCodingMethod} is {@code ISO3166_THREE_LETTER}, then release to
         * Canada and the United States would be represented as {@code "CAN USA"}.
         *
         ...
         * org.jmisb.st0102.CountryCodingMethod#GENC_TWO_LETTER} will be used as a default value.
         *
         ...
         *
         * <p>{@link org.jmisb.st0102.SecurityMetadataConstants#ST_VERSION_NUMBER} will provide the
         * current version supported by jmisb.
         *
         * <p>This value is required for the local set to be valid, and the value of {@link
         * org.jmisb.st0102.SecurityMetadataConstants#ST_VERSION_NUMBER} will be used as a default
