 ...
 *
 * <p>Map (-2^15-1)..(2^15-1) to +/-50. Use -(2^15) as "out of range" indicator. -(2^15) = 0x8000.
 *
 * <p>Resolution: ~1525 micro degrees.
 *
 * </blockquote>
 */
    ...
    public PlatformRollAngle(byte[] bytes) {
        if (bytes.length != 2) {
            throw new IllegalArgumentException(
                    "Platform Roll Angle encoding is a 2-byte signed int");
        }
