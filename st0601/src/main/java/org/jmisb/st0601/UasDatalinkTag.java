...
public enum UasDatalinkTag implements IKlvKey {
    ...
    Checksum(1),
    /**
     * Tag 2; Timestamp for all metadata in this Local Set; used to coordinate with Motion Imagery;
     * Value is a {@link PrecisionTimeStamp}.
     */
    PrecisionTimeStamp(2),
    /**
     * Tag 3; Descriptive mission identifier to distinguish event or sortie; Value is a {@link
     * UasDatalinkString}.
     */
    MissionId(3),
    ...
    SensorLongitude(14),
    /**
     * Tag 15; Altitude of sensor as measured from Mean Sea Level (MSL); Value is a {@link
     * SensorTrueAltitude}.
     */
    SensorTrueAltitude(15),
    /**
     * Tag 16; Horizontal field of view of selected imaging sensor; Value is a {@link
     * HorizontalFov}.
     */
    ...
    /**
     * Tag 18; Relative rotation angle of sensor to platform longitudinal axis; Value is a {@link
     * SensorRelativeAzimuth}.
     */
    SensorRelativeAzimuthAngle(18),
    /**
     * Tag 19; Relative elevation angle of sensor to platform longitudinal-transverse plane; Value
     * is a {@link SensorRelativeElevation}.
     */
    SensorRelativeElevationAngle(19),
    /**
     * Tag 20; Relative roll angle of sensor to aircraft platform; Value is a {@link
     * SensorRelativeRoll}.
     */
    ...
    /**
     * Tag 25; Terrain elevation at frame center relative to Mean Sea Level (MSL); Value is a {@link
    ...
    /**
     * Tag 43; Tracking gate width (x value) of tracked target within field of view; Value is a
     * {@link TargetTrackGateSize}.
     */
    TargetTrackGateWidth(43),
    /**
     * Tag 44; Tracking gate height (y value) of tracked target within field of view; Value is a
     * {@link TargetTrackGateSize}.
     */
    TargetTrackGateHeight(44),
    /**
     * Tag 45; Circular error 90 (CE90) is the estimated error distance in the horizontal direction;
     * Value is a {@link TargetErrorEstimateCe90}.
     */
    TargetErrorCe90(45),
    /**
     * Tag 46; Lateral error 90 (LE90) is the estimated error distance in the vertical (or lateral)
    ...
    /**
     * Tag 51; Vertical speed of the aircraft relative to zenith; Value is a {@link
     * PlatformVerticalSpeed}.
     */
    PlatformVerticalSpeed(51),
    /**
     * Tag 52; Angle between the platform longitudinal axis and relative wind; Value is a {@link
     * PlatformSideslipAngle}.
     */
    PlatformSideslipAngle(52),
    /**
     * Tag 53; Local pressure at airfield of known height; Value is a {@link
     * AirfieldBarometricPressure}.
     */
    AirfieldBarometricPressure(53),
    /**
     * Tag 54; Elevation of airfield corresponding to Airfield Barometric Pressure; Value is a
     * {@link AirfieldElevation}.
     */
    AirfieldElevation(54),
    /** Tag 55; Relative humidity at aircraft location; Value is a {@link RelativeHumidity}. */
    RelativeHumidity(55),
    /**
     * Tag 56; Speed projected to the ground of an airborne platform passing overhead; Value is a
     * {@link PlatformGroundSpeed}.
     */
    PlatformGroundSpeed(56),
    /**
     * Tag 57; Horizontal distance from ground position of aircraft relative to nadir, and target of
     * interest; Value is a {@link GroundRange}.
     */
    GroundRange(57),
    ...
    WeaponFired(61),
    /**
     * Tag 62; A laser's Pulse Repetition Frequency (PRF) code used to mark a target; Value is a
     * {@link LaserPrfCode}.
     */
    LaserPrfCode(62),
    ...
    /**
     * Tag 65; Version number of the UAS Datalink LS document used to generate KLV metadata; Value
     * is a {@link ST0601Version}.
     */
    UasLdsVersionNumber(65),
    /**
     * Tag 66; Covariance Matrix of the error associated with a targeted location (DEPRECATED) Value
     * is a {@link OpaqueValue}.
     */
    ...
    /**
     * Tag 69; Altitude of alternate platform as measured from Mean Sea Level (MSL); Value is an
     * {@link AlternatePlatformAltitude}.
     */
    ...
    /**
     * Tag 71; Heading angle of alternate platform connected to UAS; Value is an {@link
     * AlternatePlatformHeading}.
     */
    AlternatePlatformHeading(71),
    /**
     * Tag 72; Start time of scene, project, event, mission, editing event, license, publication,
     * etc; Value is a {@link EventStartTimeUtc}.
     */
    ...
    VmtiLocalDataSet(74),
    /**
     * Tag 75; Sensor ellipsoid height as measured from the reference WGS84 ellipsoid; Value is a
     * {@link SensorEllipsoidHeight}.
     */
    SensorEllipsoidHeight(75),
    /**
     * Tag 76; Alternate platform ellipsoid height as measured from the reference WGS84 Ellipsoid;
     * Value is a {@link AlternatePlatformEllipsoidHeight}.
     */
    AlternatePlatformEllipsoidHeight(76),
    /**
     * Tag 77; Indicates the mode of operations of the event portrayed in Motion Imagery; Value is a
     * {@link OperationalMode}.
     */
    OperationalMode(77),
    /**
     * Tag 78; Frame center ellipsoid height as measured from the reference WGS84 ellipsoid; Value
     * is a {@link FrameCenterHae}.
     */
    FrameCenterHae(78),
    /**
    ...
    /**
     * Tag 93; Angle between the platform longitudinal axis and relative wind; Value is a {@link
     * PlatformSideslipAngleFull}.
     */
    PlatformSideSlipAngle(93),
    /**
     * Tag 94; MISB ST 1204 MIIS Core Identifier binary value; Value is a {@link
     * MiisCoreIdentifier}.
     */
    ...
    CompositeImaging(99),
    /**
     * Tag 100; MISB ST 1607 Segment Local Set metadata items, used to enable metadata sharing;
     * Value is a {@link OpaqueValue}.
     */
    Segment(100),
    /**
     * Tag 101; MISB ST 1607 Amend Local Set metadata items, used to provide metadata corrections;
     * Value is a {@link OpaqueValue}.
     */
    Amend(101),
    /**
     * Tag 102; MISB ST 1010 Floating Length Pack (FLP) metadata item, providing Standard Deviation
     * and Cross Correlation (SDCC) metadata; Value is a {@link OpaqueValue}.
     */
    SdccFlp(102),
    /**
     * Tag 103; Density altitude above MSL at aircraft location; Value is a {@link
     * DensityAltitudeExtended}.
     */
    DensityAltitudeExtended(103),
    /**
     * Tag 104; Sensor ellipsoid height extended as measured from the reference WGS84 ellipsoid;
     * Value is a {@link SensorEllipsoidHeightExtended}.
     */
    SensorEllipsoidHeightExtended(104),
    /**
     * Tag 105; Alternate platform ellipsoid height extended as measured from the reference WGS84
     * ellipsoid; Value is a {@link AlternatePlatformEllipsoidHeightExtended}.
     */
    ...
    /**
     * Tag 107; Name of the operational base hosting the platform; Value is a {@link
     * UasDatalinkString}.
     */
    OperationalBase(107),
    /**
     * Tag 108; Name of the source, where the Motion Imagery is first broadcast; Value is a {@link
     * UasDatalinkString}.
     */
    BroadcastSource(108),
    /**
     * Tag 109; Distance from current position to airframe recovery position; Value is a {@link
     * RangeToRecoveryLocation}.
     */
    RangeToRecoveryLocation(109),
    /** Tag 110; Number of seconds aircraft has been airborne; Value is a {@link TimeAirborne}. */
    TimeAirborne(110),
    /**
     * Tag 111; The speed the engine (or electric motor) is rotating at; Value is a {@link
     * PropulsionUnitSpeed}.
     */
    PropulsionUnitSpeed(111),
    /**
     * Tag 112; Direction the aircraft is moving relative to True North; Value is a {@link
     * PlatformCourseAngle}.
     */
    PlatformCourseAngle(112),
    /**
     * Tag 113; Above Ground Level (AGL) height above the ground/water; Value is a {@link
     * AltitudeAGL}.
     */
    AltitudeAgl(113),
    /**
     * Tag 114; Height above the ground/water as reported by a RADAR altimeter; Value is a {@link
     * RadarAltimeter}.
     */
    RadarAltimeter(114),
     ...
     * is a {@link ControlCommandVerification}.
     */
    ControlCommandVerification(116),
    /**
     * Tag 117; The rate the sensors azimuth angle is changing; Value is a {@link
     * SensorAzimuthRate}.
     */
    SensorAzimuthRate(117),
    /**
     * Tag 118; The rate the sensors elevation angle is changing; Value is a {@link
     * SensorElevationRate}.
     */
    ...
    SensorRollRate(119),
    /**
     * Tag 120; Amount of on-board Motion Imagery storage used as a percentage of the total storage;
     * Value is a {@link OnBoardMiStoragePercentFull}.
     */
    ...
    /**
     * Tag 122; Country codes which are associated with the platform and its operation; Value is a
     * {@link CountryCodes}.
     */
    CountryCodes(122),
    /**
     * Tag 123; Count of navigation satellites in view of platform; Value is a {@link
     * NavsatsInView}.
     */
    NumberNavsatsInView(123),
    /**
     * Tag 124; Source of the navigation positioning information. (e.g., NAVSAT-GPS, NAVSAT-Galileo,
     * INS); Value is a {@link PositioningMethodSource}.
     */
    PositioningMethodSource(124),
    /**
     * Tag 125; Enumeration of operational modes of the platform (e.g., in-route, RTB); Value is a
     * {@link PlatformStatus}.
     */
    PlatformStatus(125),
    /**
     * Tag 126; Enumerated value for the current sensor control operational status; Value is a
     * {@link SensorControlMode}.
     */
    SensorControlMode(126),
    /**
     * Tag 127; Values used to compute the frame rate of the Motion Imagery at the sensor; Value is
     * a {@link SensorFrameRate}.
     */
    ...
    TargetId(129),
    /**
     * Tag 130; Geographic location of the take-off site and recovery site; Value is a {@link
     * AirbaseLocations}.
     */
    ...
    TakeOffTime(131),
    /**
     * Tag 132; Radio frequency used to transmit the Motion Imagery; Value is a {@link
     * TransmissionFrequency}.
     */
    TransmissionFrequency(132),
    /**
     * Tag 133; The total capacity of on-board Motion Imagery storage; Value is a {@link
     * OnBoardMiStorageCapacity}.
     */
    OnBoardMiStorageCapacity(133),
    /**
     * Tag 134; For a variable zoom system, the percentage of zoom; Value is a {@link
     * ZoomPercentage}.
     */
    ZoomPercentage(134),
    ...
    /**
     * Create a UasDatalinkTag for the given code.
     *
     * @param tagCode The integer code
