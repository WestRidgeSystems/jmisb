...
public class CentroidPixelRowTest {
    ...
    public void testConstructFromEncodedBytes65536() {
        CentroidPixelRow index =
                new CentroidPixelRow(new byte[] {(byte) 0x01, (byte) 0x00, (byte) 0x00});
    ...
    public void testConstructFromEncodedBytes16777215() {
        CentroidPixelRow index =
                new CentroidPixelRow(new byte[] {(byte) 0xFF, (byte) 0xFF, (byte) 0xFF});
