...
public class VObjectLSTest extends LoggerChecks {
    ...
    final byte[] ontologyClassBytes =
            new byte[] {0x02, 8, 0x4D, 0x75, 0x73, 0x68, 0x72, 0x6F, 0x6F, 0x6D};

    final byte[] ontologyIdBytes =
            new byte[] {
                0x03, 2,
                0x01, 0x02
            };

    final byte[] confidenceBytes =
            new byte[] {
                0x04, 2,
                0x30, 0x00
            };
    ...
    private final byte[] mergedBytes =
            new byte[] {
                ...
                0x70, 0x69, 0x7A, 0x7A, 0x61, 0x2D, 0x6F, 0x6E, 0x74, 0x6F, 0x6C, 0x6F, 0x67, 0x79,
                0x2F, 0x6D, 0x61, 0x73, 0x74, 0x65, 0x72, 0x2F, 0x70, 0x69, 0x7A, 0x7A, 0x61, 0x2E,
                0x6F, 0x77, 0x6C, 0x02, 8, 0x4D, 0x75, 0x73, 0x68, 0x72, 0x6F, 0x6F, 0x6D, 0x03, 2,
                0x01, 0x02, 0x04, 2, 0x30, 0x00
            };
    ...
    public static void checkOntologyClassExample(VObjectLS vObjectLS) {
        ...
        VmtiTextString textString =
                (VmtiTextString) vObjectLS.getField(VObjectMetadataKey.ontologyClass);
