...
public class VFeatureLSTest extends LoggerChecks {
    ...
    public void parseTag1() throws KlvParseException, URISyntaxException {
        final byte[] bytes =
                new byte[] {
                    0x01, 45, 0x75, 0x72, 0x6e, 0x3a, 0x75, 0x75, 0x69, 0x64, 0x3a, 0x66, 0x38,
                    0x31, 0x64, 0x34, 0x66, 0x61, 0x65, 0x2d, 0x37, 0x64, 0x65, 0x63, 0x2d, 0x31,
                    0x31, 0x64, 0x30, 0x2d, 0x61, 0x37, 0x36, 0x35, 0x2d, 0x30, 0x30, 0x61, 0x30,
                    0x63, 0x39, 0x31, 0x65, 0x36, 0x62, 0x66, 0x36
                };
    ...
    public static void checkSchemaFeatureExample(VFeatureLS localSet) throws URISyntaxException {
        final String stringVal =
                "<gml:DataBlock><gml:rangeParameters><gml:CompositeValue><gml:valueComponents><Temperature uom=\"urn:x-si:v1999:uom:degreesC\">template</Temperature><Pressure uom=\"urn:x-si:v1999:uom:kPa\">template</Pressure></gml:valueComponents></gml:CompositeValue></gml:rangeParameters><gml:tupleList>3,101.2</gml:tupleList></gml:DataBlock>";
    ...
    public void constructFromMap() throws KlvParseException, URISyntaxException, IOException {
        ...
        IVmtiMetadataValue schema =
                new VmtiUri(
                        VmtiUri.VFEATURE_SCHEMA, "urn:uuid:f81d4fae-7dec-11d0-a765-00a0c91e6bf6");
        values.put(VFeatureMetadataKey.schema, schema);
        IVmtiMetadataValue schemaFeature =
                new VmtiTextString(
                        VmtiTextString.VFEATURE_SCHEMA_FEATURE,
                        "<gml:DataBlock><gml:rangeParameters><gml:CompositeValue><gml:valueComponents><Temperature uom=\"urn:x-si:v1999:uom:degreesC\">template</Temperature><Pressure uom=\"urn:x-si:v1999:uom:kPa\">template</Pressure></gml:valueComponents></gml:CompositeValue></gml:rangeParameters><gml:tupleList>3,101.2</gml:tupleList></gml:DataBlock>");
