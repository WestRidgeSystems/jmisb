...
public class DensityAltitudeExtendedTest {
    ...
    public void testConstructFromEncoded() {
        // From ST:
        DensityAltitudeExtended alt =
                new DensityAltitudeExtended(new byte[] {(byte) 0x2F, (byte) 0x92, (byte) 0x1E});
    ...
    public void testFactory() throws KlvParseException {
        ...
        IUasDatalinkValue v =
                UasDatalinkFactory.createValue(UasDatalinkTag.DensityAltitudeExtended, bytes);
