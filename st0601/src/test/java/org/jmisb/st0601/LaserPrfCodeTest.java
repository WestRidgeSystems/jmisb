...
public class LaserPrfCodeTest {
    ...
    @Test(
            ...
            expectedExceptionsMessageRegExp = "Laser PRF Code must be in the range \\[111, 8888\\]")
    ...
    @Test(
            ...
            expectedExceptionsMessageRegExp =
                    "Laser PRF Code must only contain 1 through 8, not 0 or 9")
    ...
    @Test(
            expectedExceptions = IllegalArgumentException.class,
            expectedExceptionsMessageRegExp = "Laser PRF Code encoding is a 2-byte unsigned int")
