...
public class RvtLocalSet implements IMisbMessage {
    ...
    /** Tag value from ST 0601 for the nested RVT local set. */
    private static final int UAS_DATALINK_RVT_TAG = 73;
                ...
                case CRC32:
                    if (was0601Nested) {
                        ...
                        ArrayBuilder builder =
                                new ArrayBuilder()
                                        .appendAsOID(UAS_DATALINK_RVT_TAG)
     ...
     * org.jmisb.st0806.userdefined.RvtUserDefinedMetadataKey#NumericId}. This is required by
     * ST0806, and is used to differentiate between the various user defined local sets nested
     ...
     * org.jmisb.st0806.poiaoi.RvtPoiMetadataKey#PoiAoiNumber}. This is required by ST0806, and is
     * used to differentiate between the various POI local sets nested within this RVT local set.
     *
     ...
     * org.jmisb.st0806.poiaoi.RvtAoiMetadataKey#PoiAoiNumber}. This is required by ST0806, and is
     * used to differentiate between the various AOI local sets nested within this RVT local set.
     *
