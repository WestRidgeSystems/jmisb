...
public class RvtMetadataIdentifierTest {
    ...
    @Test
    public void checkIdentifierComparison() {
        RvtMetadataIdentifier uut1 = new RvtMetadataIdentifier(RvtMetadataKind.AOI, 1);
        RvtMetadataIdentifier uut2 = new RvtMetadataIdentifier(RvtMetadataKind.AOI, 1);
        RvtMetadataIdentifier uut3 = new RvtMetadataIdentifier(RvtMetadataKind.AOI, 3);
        assertEquals(uut1.compareTo(uut1), 0);
        assertEquals(uut1.compareTo(uut2), 0);
        assertTrue(uut1.compareTo(uut3) < 0);
        assertTrue(uut3.compareTo(uut1) > 0);
    }
}
