...
import org.jmisb.st0903.vobject.VObjectMetadataKey;
import org.testng.annotations.Test;

/** Tests for VObjectSeries Series (ST0903 VTarget Tag 106). */
public class VObjectSeriesTest {
    final byte[] bytesOneObject =
            new byte[] {
                83, // combined length
                0x01, 71, // Tag 1 and length
                0x68, 0x74, 0x74, 0x70, 0x73, 0x3A, 0x2F, 0x2F, 0x72, 0x61, 0x77, 0x2E, 0x67, 0x69,
                0x74, 0x68, 0x75, 0x62, 0x75, 0x73, 0x65, 0x72, 0x63, 0x6F, 0x6E, 0x74, 0x65, 0x6E,
                0x74, 0x2E, 0x63, 0x6F, 0x6D, 0x2F, 0x6F, 0x77, 0x6C, 0x63, 0x73, 0x2F, 0x70, 0x69,
                0x7A, 0x7A, 0x61, 0x2D, 0x6F, 0x6E, 0x74, 0x6F, 0x6C, 0x6F, 0x67, 0x79, 0x2F, 0x6D,
                0x61, 0x73, 0x74, 0x65, 0x72, 0x2F, 0x70, 0x69, 0x7A, 0x7A, 0x61, 0x2E, 0x6F, 0x77,
                0x6C, 0x02, 8, // Tag 2 and length
                0x4D, 0x75, 0x73, 0x68, 0x72, 0x6F, 0x6F, 0x6D
            };

    final byte[] bytesTwoObjects =
            new byte[] {
    ...
    public void constructFromValue() throws KlvParseException, URISyntaxException {
        ...
        IVmtiMetadataValue ontologyValue =
                VObjectLS.createValue(
                        VObjectMetadataKey.ontology,
                        new byte[] {
        ...
        IVmtiMetadataValue ontologyClassValue =
                VObjectLS.createValue(
                        VObjectMetadataKey.ontologyClass,
                        new byte[] {0x4D, 0x75, 0x73, 0x68, 0x72, 0x6F, 0x6F, 0x6D});
