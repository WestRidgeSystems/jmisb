...
public class VmtiLocalSet implements IMisbMessage {
     ...
     */
    @Deprecated
    public static org.jmisb.st0903.IVmtiMetadataValue createValue(VmtiMetadataKey tag, byte[] bytes)
            throws org.jmisb.api.common.KlvParseException {
    ...
    public VmtiLocalSet(byte[] bytes) throws KlvParseException {
        ...
        if (setLength > UniversalLabel.LENGTH) {
            ...
            if (Arrays.equals(VmtiLocalSetUl.getBytes(), ul)) {
